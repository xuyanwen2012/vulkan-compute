...
#include "core/vulkan_resource.hpp"
...
// write ostream for bind meta data
...
// write ostream for push constant meta data
std::ostream& operator<<(std::ostream& os,
                         const ComputeShader::PushConstantMetaData& metaData) {

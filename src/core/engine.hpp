...
namespace core
{
	...
	protected:
		...
		void create_descriptor_set()
		{
			...
			descriptor_set_ = vkh_device_.allocateDescriptorSets(set_alloc_info).front();
		...
		void create_compute_pipeline()
		{
			...
			constexpr std::array spec_map_content{
				ComputeShaderProcessUnit(), 1u, 1u
			};
		...
		void create_command_pool()
		{
			...
			command_buffer_ =
				vkh_device_.allocateCommandBuffers(command_buffer_allocate_info).front();
		}
